...
def create_meal(meal: str, cuisine: str, price: float, difficulty: str) -> None:
    ...
    Args:
        ...
        difficulty (str): The difficulty level, must be 'LOW', 'MED', or 'HIGH'.

    Raises:
        ValueError: If the price is non-positive, the difficulty level is invalid, or the meal already exists.
...
def delete_meal(meal_id: int) -> None:
    """
    Marks a meal as deleted in the database by its meal ID.

    Args:
        meal_id (int): The ID of the meal to mark as deleted.

    Raises:
        ValueError: If the meal ID is not found or the meal has already been deleted.
        sqlite3.Error: If any database error occurs.
    """
    try:
        with get_db_connection() as conn:
...
def get_leaderboard(sort_by: str="wins") -> dict[str, Any]:
    ...
    Args:
        sort_by (str): The field to sort by, must be 'wins' or 'win_pct'.
    ...
    Returns:
        list[dict[str, Any]]: A list of dictionaries containing meal leaderboard details.
    """
    query = """
...
def get_meal_by_id(meal_id: int) -> Meal:
    ...
    Raises:
        ValueError: If the meal ID is not found or the meal has been deleted.
        sqlite3.Error: If any database error occurs.
...
def get_meal_by_name(meal_name: str) -> Meal:
    ...
    Raises:
        ValueError: If the meal name is not found or the meal has been deleted.
        sqlite3.Error: If any database error occurs.
...
def update_meal_stats(meal_id: int, result: str) -> None:
    ...
    Raises:
        ValueError: If the meal ID is not found, the meal has been deleted, or the result is invalid.
        sqlite3.Error: If any database error occurs.
    """
    try:
        with get_db_connection() as conn:
